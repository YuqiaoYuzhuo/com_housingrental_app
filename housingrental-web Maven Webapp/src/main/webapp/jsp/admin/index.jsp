                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${SysPro.system_static_sourceurl_prefix}/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${SysPro.system_static_sourceurl_prefix}/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
