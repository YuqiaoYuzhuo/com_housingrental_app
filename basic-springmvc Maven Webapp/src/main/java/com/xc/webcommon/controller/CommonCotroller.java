package com.xc.webcommon.controller;
...
import com.xc.webcommon.model.ReturnModel;
import com.xc.webcommon.springview.DownloadByFileView;
import com.xc.webcommon.springview.DownloadByURLView;
...
public class CommonCotroller {
	...
	binder.registerCustomEditor(Timestamp.class, new CustomDateEditor(dateFormat, true));   //true:允许输入空值，false:不能为空值  
	}
}
